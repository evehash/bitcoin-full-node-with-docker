...
| [I2P](https://github.com/i2p/i2p.i2p) | Optional additional privacy network for advanced users. | 2.13.0 | ![I2P version status](https://img.shields.io/endpoint?url=https%3A%2F%2Fevehash.github.io%2Fbitcoin-full-node-with-docker%2Fversion-status%2Fi2p.json) |
